                         ...
                         struct icnbrec_transit_switch_port *tsp)
{
    ...
    const struct sbrec_port_binding *peer = find_sb_pb_by_name(
        ctx->sbrec_port_binding_by_name, peer_name);
                ...
                const struct sbrec_port_binding *sb_pb)
{
    ...
    /* TODO: Only update if lrp is not remote*/
...
static void
sync_ts_isb_pb(struct ic_context *ctx, struct icnbrec_transit_switch_port *tsp,
                const struct sbrec_port_binding *sb_pb,
                const struct icsbrec_port_binding *isb_pb)
{
    const char *address = get_lp_address_for_tr_pb(ctx, tsp);
...
static const struct sbrec_port_binding *
find_lsp_in_sb(struct ic_context *ctx, const struct nbrec_logical_switch_port *lsp)
{
